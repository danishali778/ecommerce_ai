...
@celery_app.task(name="app.tasks.fraud.generate_fraud_risk_assessment", bind=True)
def generate_fraud_risk_assessment(self, agent_run_id: str, trace_id: str | None = None) -> None:
