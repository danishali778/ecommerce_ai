...
@celery_app.task(name="app.tasks.pricing.generate_pricing_recommendation", bind=True)
def generate_pricing_recommendation(self, agent_run_id: str, trace_id: str | None = None) -> None:
