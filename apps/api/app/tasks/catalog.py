...
@celery_app.task(name="app.tasks.catalog.generate_product_content_draft", bind=True)
def generate_product_content_draft(self, agent_run_id: str, trace_id: str | None = None) -> None:
