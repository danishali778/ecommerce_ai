...
@celery_app.task(name="app.tasks.inventory.generate_inventory_reorder_suggestion", bind=True)
def generate_inventory_reorder_suggestion(self, agent_run_id: str, trace_id: str | None = None) -> None:
